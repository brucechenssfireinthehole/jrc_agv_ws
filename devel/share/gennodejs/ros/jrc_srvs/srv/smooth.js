...
class smoothRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type smoothRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type smoothRequest
    let len;
    let data = new smoothRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new smoothRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class smoothResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type smoothResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type smoothResponse
    let len;
    let data = new smoothResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new smoothResponse(null);
...
module.exports = {
  ...
  datatype() { return 'jrc_srvs/smooth'; }
};
