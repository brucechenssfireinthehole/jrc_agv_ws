...
class smooth_srv_multiRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type smooth_srv_multiRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type smooth_srv_multiRequest
    let len;
    let data = new smooth_srv_multiRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new smooth_srv_multiRequest(null);
...
class smooth_srv_multiResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type smooth_srv_multiResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type smooth_srv_multiResponse
    let len;
    let data = new smooth_srv_multiResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new smooth_srv_multiResponse(null);
...
module.exports = {
  Request: smooth_srv_multiRequest,
  Response: smooth_srv_multiResponse,
  md5sum() { return '3b1e979c6d58d1f5eaa86cabfb1c7458'; },
  datatype() { return 'velocity_smooth/smooth_srv_multi'; }
};
